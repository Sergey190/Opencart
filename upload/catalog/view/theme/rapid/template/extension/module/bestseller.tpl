<div class="row">
  <div class="col-xs-12">
    ...
    <div id="bestseller<?php echo $module; ?>" class="owl-carousel owl-module" style="opacity: 1;">
...
<script >
  $('#bestseller<?php echo $module; ?>').owlCarousel({
    responsiveBaseWidth: '#bestseller<?php echo $module; ?>',
