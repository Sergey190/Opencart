<div class="row">
  <div class="col-xs-12">
    ...
    <div id="special<?php echo $module; ?>" class="owl-carousel owl-module" style="opacity: 1;">
...
<script >
  $('#special<?php echo $module; ?>').owlCarousel({
    responsiveBaseWidth: '#special<?php echo $module; ?>',
