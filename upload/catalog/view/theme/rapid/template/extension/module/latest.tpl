<div class="row">
  <div class="col-xs-12">
    ...
    <div id="latest<?php echo $module; ?>" class="owl-carousel owl-module" style="opacity: 1;">
...
<script >
  $('#latest<?php echo $module; ?>').owlCarousel({
    responsiveBaseWidth: '#latest<?php echo $module; ?>',
