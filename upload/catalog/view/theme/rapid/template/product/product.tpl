      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
            <?php if ($manufacturer) { ?>
            <li><span class="text-muted"><?php echo $text_manufacturer; ?></span> <a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a></li>
            <?php } ?>
            <li><span class="text-muted"><?php echo $text_model; ?></span> <?php echo $model; ?></li>
            <?php if ($reward) { ?>
            <li><span class="text-muted"><?php echo $text_reward; ?></span> <?php echo $reward; ?></li>
            <?php } ?>
            <li><span class="text-muted"><?php echo $text_stock; ?></span> <?php echo $stock; ?></li>
          </ul>
          <?php if ($price) { ?>
          <ul class="list-unstyled">
            <?php if (!$special) { ?>
            <li>
                <span class="h4"><?php echo $price; ?></span>
            </li>
            <?php } else { ?>

            <li>
              <span class="h4"><?php echo $special; ?></span> <br>
              <span style="color:#E8110F;text-decoration: line-through;"><?php echo $price; ?></span>
            </li>
            <?php } ?>
            <?php if ($tax) { ?>
            <li><span class="text-muted"><?php echo $text_tax; ?></span> <?php echo $tax; ?></li>
            <?php } ?>
            <?php if ($points) { ?>
            <li><span class="text-muted"><?php echo $text_points; ?></span> <?php echo $points; ?></li>
            <?php } ?>
            <?php if ($discounts) { ?>
            <li>
              <hr>
